...
# df = pd.read_csv('/shared/nas/data/m1/khhuang3/disinformation_correction/News-Media-Reliability/data/trustworthy_sources.csv')
############ YOUR CONFIG ############
# download dir for warc files
my_local_download_dir_warc = './bbc_download_warc/'
# download dir for articles
my_local_download_dir_article = './bbc_download_articles/'
# hosts (if None or empty list, any host is OK)
# my_filter_valid_hosts = df.source_url_normalized.tolist() + ['nytimes.com']#[]#[]  # example: ['elrancaguino.cl']
my_filter_valid_hosts = ['bbc.com']
# start date (if None, any date is OK as start date), as datetime
my_filter_start_date = datetime.datetime(2016, 9, 1)
# end date (if None, any date is OK as end date), as datetime
my_filter_end_date = datetime.datetime(2022, 1, 1)  # datetime.datetime(2016, 12, 31)
...
my_warc_files_start_date = datetime.datetime(2016, 9, 1) # example: datetime.datetime(2020, 3, 1)
my_warc_files_end_date = datetime.datetime(2022, 1, 1) # example: datetime.datetime(2020, 3, 2)
...
my_number_of_extraction_processes = 30
